...
export default () => {
    ...
    return (<>
        ...
        <footer>
            <p title={'Copyright 2022 - ' + date}>&copy;</p> <p>Made with &hearts; by Akhil Ashokan &nbsp;

            </p>
            <a href="https://github.com/akhilashokan/akhilashokan.github.io" target={"_blank"} title="link to github repo">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" className="githubLink" width={10}>
