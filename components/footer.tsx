...
export default function Footer() {
    ...
    return (
        <footer className="text-base flex items-center justify-center gap-0.5 opacity-50 mt-8 pb-2 z-2">
            ...
            <a href="https://github.com/akhilashokan/akhilashokan.github.io" rel="noreferrer" target={"_blank"} title="link to github repo">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" className="" width={10}>
