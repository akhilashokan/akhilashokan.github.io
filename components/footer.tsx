...
export default function Footer() {
    ...
    return (
        <footer className="text-base flex items-center justify-center gap-1 opacity-50 mt-8 pb-2 z-2">
            <p title={'Copyright 2022 - ' + date}>&copy;</p>
            <p>Made with &hearts; by Akhil Ashokan</p>
            <a href="https://github.com/akhilashokan/akhilashokan.github.io" rel="noreferrer" target={"_blank"} title="link to github repo">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width={10} className="fill-gray-950 dark:fill-gray-200">
